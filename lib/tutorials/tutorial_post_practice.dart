...
class InstructionPostPracticePage extends StatefulWidget {
  const InstructionPostPracticePage({Key? key}) : super(key: key);
  @override
  InstructionPostPracticePageState createState() =>
      InstructionPostPracticePageState();
}

class InstructionPostPracticePageState
    extends State<InstructionPostPracticePage> {
  @override
  void initState() {
    super.initState();
                    ...
                    onPressed: currentInstructionIndex < instructions.length - 1
                        ...
                        : () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const InstructionsPacientePage(),
                              ),
                            );
                          },
                    child: const Text(
