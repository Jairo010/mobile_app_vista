...
class InstructionPostPacientPage extends StatefulWidget {
  ...
  @override
  InstructionPostPacientPageState createState() => InstructionPostPacientPageState();
}

class InstructionPostPacientPageState extends State<InstructionPostPacientPage> {
  @override
  void initState() {
    super.initState();
                  ...
                  onPressed: currentInstructionIndex < instructions.length - 1
                      ...
                      : () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const FinalTutorialsPage(),
                            ),
                          );
                        },
                  child: const Text(
